...
const MotherForm = ({ parentsFormData, handleChange }: MotherFormTypes) => {
  // handleImage
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    value={parentsFormData.mother_aadhar_front}
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    value={parentsFormData.mother_aadhar_back}
                    onChange={handleImageChange}
                  />
                  {previewUrl && (
                    <Image
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    value={parentsFormData.mother_voter_front}
                    onChange={handleImageChange}
                  />
                  {previewUrl && (
                    <Image
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    value={parentsFormData.mother_voter_back}
                    onChange={handleImageChange}
                  />
                  {previewUrl && (
                    <Image
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      value={parentsFormData.mother_optional_front}
                      onChange={handleImageChange}
                    />
                    {previewUrl && (
                      <Image
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      value={parentsFormData.mother_optional_back}
                      onChange={handleImageChange}
                    />
                    {previewUrl && (
                      <Image
